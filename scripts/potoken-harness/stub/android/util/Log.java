...
public class Log {
    ...
    private static int p(String lvl,String t,String m){ String s=lvl+"/"+t+": "+m; LINES.add(s); if(echo) System.out.println("    "+s); return 0; }
    ...
    public static boolean saw(String needle){ synchronized(LINES){ for(String s:LINES) if(s.contains(needle)) return true; } return false; }
