...
function injectValues(queryMap) {
    ...
    document.getElementById('errorTitleSubText').innerHTML = queryMap.subtitle;
    ...
    if (!queryMap.image) {
      ...
      errorImage.src = "resource://android/assets/error/" + queryMap.image;
    }

    const errorImageFooter = document.getElementById('errorImageFooter');
    if (!queryMap.imageFooter) {
        errorImageFooter.remove();
    } else {
        errorImageFooter.src = "resource://android/assets/error/" + queryMap.imageFooter;
    }
